...
@books_router.post("/", response_model=ReturnedBook, status_code=status.HTTP_201_CREATED)  # noqa e501
...
async def update_book(book_id: int, new_data: ReturnedBook, session: DBSession):  # noqa e501
